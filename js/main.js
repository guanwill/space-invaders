...
var game = new Phaser.Game(1350, 660, Phaser.AUTO, 'game-area'); //set resolution. phaser.auto will choose to render on canvas or webGL depending on availability.
...
var GameState = {
  ...
  create: function() {
    ...
    starfield = game.add.tileSprite(0, 0, 1330, 660, 'starfield'); //to load the background image into the main game, you have to create a new sprite for each image. this.game always refer to the MAIN GAME object. sprite() takes x, y coordinates and key of image object you want to place the image as arguments
    game.world.setBounds(-55, 20, 1390, 680);
